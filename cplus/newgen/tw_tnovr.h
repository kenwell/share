...
#ifndef __TW_TNOVR_H_INCLUDED__
#define __TW_TNOVR_H_INCLUDED__
...
{
public:
    TnovrClient(boost::asio::io_service& io_service, std::string ipAddress, short port, TwTnovrServer& tnovrServer);
