/**
 * @file tw_comm_order.h
 * @brief 定义委托发送
 * @author wugl
 */

#ifndef __TW_COMM_ORDER_H_INCLUDED__
#define __TW_COMM_ORDER_H_INCLUDED__
...
{
public:
    TwCommOrder(boost::asio::io_service& io_service, std::string ipAddress, short port);
